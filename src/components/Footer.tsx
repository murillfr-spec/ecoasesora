...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 border-t-4 border-emerald-500 pt-12 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-slate-800">
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <a href="tel:+34685911111" className="flex items-center gap-2 text-emerald-400 font-bold hover:underline">
                <Phone className="w-4 h-4" />
                <span>685 91 11 11</span>
              </a>
              <a href="mailto:info@ecoasesora.com" className="flex items-center gap-2 text-slate-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              {SERVICE_CATEGORIES.map((cat) => (
                <li key={cat.id}>
                  <a href={`#${cat.id}`} className="hover:text-emerald-400 transition-colors flex items-center gap-1.5">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="#por-que-elegirnos" className="hover:text-emerald-400 transition-colors">Por Qué Elegirnos</a></li>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg overflow-hidden border border-slate-700 shadow-md h-36 bg-slate-800">
              <iframe
